        ...
        <div class="sidebar-content">
                ...
                <ul class="site-logo">
                    <li>
                        ...
                        <a href="index.php">
                            ...
                            <span class="brand-text">HRCW</span>
                        </a>
                        <!-- END LOGO -->
                    </li>
                </ul>
            ...
            <nav class="main-menu">
                <ul class="nav metismenu">
                    ...
                    <li class="<?php echo($_SERVER['PHP_SELF'] == "/cv_member/index.php"
                        ? "active" : ""); ?> nav-dropdown">
                        <a href="index.php"><i class="icon dripicons-meter"></i><span>Dashboard</span></a>
                    </li>
                    <li class="<?php echo($_SERVER['PHP_SELF'] == "/cv_member/departments.php" ||
                    $_SERVER['PHP_SELF'] == "/cv_member/ministries.php" ||
                    $_SERVER['PHP_SELF'] == "/cv_member/cells.php"
                        ? "active" : ""); ?> nav-dropdown">
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-gear"></i><span>Branch Groupings</span></a>
                    ...
                    <li class="<?php echo($_SERVER['PHP_SELF'] == "/cv_member/member.php"
                        ? "active" : ""); ?> nav-dropdown">
                    ...
                    <li class="nav-dropdown">
                        <a href="#"><i class="icon icon-envelope-letter"></i><span>SMS</span></a>
                    </li>
                    <li class="nav-dropdown">
                        <a href="#"><i class="icon icon-emotsmile"></i><span>Birthday Messages</span></a>
                    </li>
                ...
                <li class="nav-item nav-text dropdown dropdown-menu-md">
                    <a href="javascript:void(0)">
							<span style="text-transform: uppercase">
								<?php $getname = $mysqli->query("select * from branch where id = '$branch'");
                        ...
                        <div class="dropdown-header pb-3">
                            <div class="media d-user">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-0 mb-0"><?php echo $fullname = $_SESSION['fullname']; ?></h5>
