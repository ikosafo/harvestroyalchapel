...
$dep = $mysqli->query("SELECT * FROM f_contributions WHERE branch = '$branch' 
...
?>
                ...
                while ($resdep = $dep->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button"
                                    data-type="confirm"
                                    class="btn btn-sm btn-danger js-sweetalert delete_contributions"
    ...
    <script>
        ...
        $(document).on('click', '.delete_contributions', function () {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_contributions.php",
                            data: {
                                i_index: i_index
                            },
                            dataType: "html",
                        ...
                        swal("Deleted!", "contributions has been deleted.", "success");
