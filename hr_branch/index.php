...
<?php $getnum = $mysqli->query("select * from member where branch = '$branch'");
...
?>">0</h5>
           ...
           data-count="<?php $getnumm = $mysqli->query("select * from member where branch = '$branch' and gender = 'Male'");
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-3">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title m-b-5 counter" data-count="
<?php $getnumf = $mysqli->query("select * from member where branch = '$branch' and gender = 'Female'");
...
<?php $getnums = $mysqli->query("select * from member where branch = '$branch' and maritalstatus = 'Single'");
