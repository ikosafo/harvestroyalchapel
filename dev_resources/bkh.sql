...
MySQL - 8.0.18 : Database - harvestroyal
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`harvestroyal` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `branch`(`id`,`name`,`location`,`code`) values (4,'Kwashieman Branch','Kwashieman','KW2');
...
/*Table structure for table `church_worker` */

DROP TABLE IF EXISTS `church_worker`;

CREATE TABLE `church_worker` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `memberid` varchar(256) DEFAULT NULL,
  `branch` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
/*Data for the table `church_worker` */
...
/*Data for the table `f_contributions` */
...
/*Data for the table `f_firstfruit` */
...
/*Data for the table `f_mpcontributions` */
...
insert  into `users_admin`(`id`,`fullname`,`username`,`password`,`branch`,`usertype`) values (4,'Divine Camme','divine','e10adc3949ba59abbe56e057f20f883e','4',NULL);
...
/*Data for the table `users_adminmain` */

insert  into `users_adminmain`(`id`,`fullname`,`username`,`password`) values (2,'Administrator','admin','e10adc3949ba59abbe56e057f20f883e');
